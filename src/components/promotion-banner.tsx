...
export function PromotionBanner({ promotions }: PromotionBannerProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center max-w-screen-xl mx-auto">
      {activePromotions.map((promotion, index) => {
        ...
        return (
          <motion.div
            key={promotion.id}
            className="bg-card dark:border dark:border-primary rounded-lg shadow-md overflow-hidden w-full h-full flex flex-col"
